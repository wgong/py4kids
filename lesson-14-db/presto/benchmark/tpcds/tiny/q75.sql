  ...
  all_sales AS (
   ...
   FROM
     (
      ...
      INNER JOIN tpcds.tiny.date_dim ON ("d_date_sk" = "cs_sold_date_sk"))
...
UNION       SELECT
      ...
      INNER JOIN tpcds.tiny.item ON ("i_item_sk" = "ss_item_sk"))
      INNER JOIN tpcds.tiny.date_dim ON ("d_date_sk" = "ss_sold_date_sk"))
      LEFT JOIN tpcds.tiny.store_returns ON ("ss_ticket_number" = "sr_ticket_number")
...
UNION       SELECT
      ...
      INNER JOIN tpcds.tiny.item ON ("i_item_sk" = "ws_item_sk"))
      INNER JOIN tpcds.tiny.date_dim ON ("d_date_sk" = "ws_sold_date_sk"))
      LEFT JOIN tpcds.tiny.web_returns ON ("ws_order_number" = "wr_order_number")
