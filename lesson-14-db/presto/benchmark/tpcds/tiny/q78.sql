...
, cs AS (
   ...
   LEFT JOIN tpcds.tiny.catalog_returns ON ("cr_order_number" = "cs_order_number")
      AND ("cs_item_sk" = "cr_item_sk"))
   INNER JOIN tpcds.tiny.date_dim ON ("cs_sold_date_sk" = "d_date_sk"))
...
, ss AS (
   ...
   LEFT JOIN tpcds.tiny.store_returns ON ("sr_ticket_number" = "ss_ticket_number")
      AND ("ss_item_sk" = "sr_item_sk"))
   INNER JOIN tpcds.tiny.date_dim ON ("ss_sold_date_sk" = "d_date_sk"))
