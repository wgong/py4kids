  ...
  (
   ...
   FROM
     (
      ...
      FROM
        (tpcds.tiny.web_sales ws
      LEFT JOIN tpcds.tiny.web_returns wr ON ("ws"."ws_order_number" = "wr"."wr_order_number")
  ...
  (
   ...
   FROM
     (
      ...
      FROM
        (tpcds.tiny.catalog_sales cs
      LEFT JOIN tpcds.tiny.catalog_returns cr ON ("cs"."cs_order_number" = "cr"."cr_order_number")
  ...
  (
   ...
   FROM
     (
      ...
      FROM
        (tpcds.tiny.store_sales sts
      LEFT JOIN tpcds.tiny.store_returns sr ON ("sts"."ss_ticket_number" = "sr"."sr_ticket_number")
