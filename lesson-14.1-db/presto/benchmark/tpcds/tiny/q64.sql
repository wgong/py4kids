...
, cross_sales AS (
   ...
   , cs_ui
   , tpcds.tiny.date_dim d1
   , tpcds.tiny.date_dim d2
   , tpcds.tiny.date_dim d3
   , tpcds.tiny.store
   , tpcds.tiny.customer
   , tpcds.tiny.customer_demographics cd1
   , tpcds.tiny.customer_demographics cd2
   , tpcds.tiny.promotion
   , tpcds.tiny.household_demographics hd1
   , tpcds.tiny.household_demographics hd2
   , tpcds.tiny.customer_address ad1
   , tpcds.tiny.customer_address ad2
   , tpcds.tiny.income_band ib1
   , tpcds.tiny.income_band ib2
   , tpcds.tiny.item
