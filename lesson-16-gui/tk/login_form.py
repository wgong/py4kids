#https://github.com/nj-AllAboutCode/Python-Tkinter-Projects/blob/master/tkinter-LoginForm-Sqlite3.py
...
class main:
    def __init__(self,master):
    	# Window 
        self.master = master
        # for login form - existing User
        self.username = StringVar()
        self.password = StringVar()

        # for Create Account form - New User
