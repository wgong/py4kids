...
def main():
    ...
    if st.session_state.qa_cache:
        st.sidebar.write("Cached Questions:", len(st.session_state.qa_cache))
        if st.sidebar.expander("View Cached Questions"):
            for q in st.session_state.qa_cache.keys():
    ...
    if query := st.chat_input("Ask a question about your documents:"):
        if "qa_chain" in st.session_state:
            ...
            st.error("No documents available. Please check if Chroma DB is properly initialized.")
