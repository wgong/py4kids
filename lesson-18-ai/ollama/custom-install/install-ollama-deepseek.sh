...
# Allow custom OLLAMA_HOME and OLLAMA_MODELS
OLLAMA_HOME="${OLLAMA_HOME:-/usr/local}"
OLLAMA_MODELS="${OLLAMA_MODELS:-$OLLAMA_HOME/.ollama/models}"

OLLAMA_INSTALL_DIR="$OLLAMA_HOME/bin"
