Please revise Ollama install script by incorporating the following 3 requirements: 

1) allow custom OLLAMA_HOME and OLLAMA_MODELS, e.g. """ 
OLLAMA_HOME="/opt/ollama"
OLLAMA_MODELS="/opt/ollama/.ollama/models"
"""; 

2) no need to backup models for upgrading; 

3) include all necessary code from the original script, and don't skip and ask user to merge snippet from the original code, that could introduce error due to human merging code, 
