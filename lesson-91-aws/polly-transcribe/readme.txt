...
$ python run_polly.py lincohn-gettysburg.txt Matthew                                     # polly

$ python run_transcribe.py lincohn-gettysburg-Matthew.mp3 

$ python compare_2text_files.py lincohn-gettysburg.txt lincohn-gettysburg-Matthew-tx.txt   # check accuracy
# 0.9838
