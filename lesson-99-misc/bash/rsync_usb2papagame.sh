...
PC_NAME="papagame"
#USB_DRIVE_NAME="USB321FD"   # gongai
USB_DRIVE_NAME="01BE-0BAA"   # papagame
# change for different USB drive
# Define the mount point for your USB flash drive (replace with your actual path)
USB_MOUNT_POINT="/media/$PC_NAME/$USB_DRIVE_NAME"

src_dir_root="$USB_MOUNT_POINT/1_Biz"
tgt_dir_root="/home/$PC_NAME/projects/1_Biz"
...
if [ $exit_code -eq 1 ]; then
  echo "Error: USB flash drive not mounted at '$USB_MOUNT_POINT'"
  exit $exit_code
fi
